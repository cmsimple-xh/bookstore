...
/* left block */
        ...
        htmlBuffer.push("<span class='tablePagination_perPage_span'>Records per page:</span>"); // translate " per page" in your language
...
/* page from block */
        ...
        htmlBuffer.push("Page"); // translate "Page " in your language
        ...
        htmlBuffer.push("from<span id='tablePagination_totalPages' class='tablePagination_totalPages'> "+totalPages+" </span>");  // translate " of " in your language
        htmlBuffer.push("</div>");
/* right arrows block */

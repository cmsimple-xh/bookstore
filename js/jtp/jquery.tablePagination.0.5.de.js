...
/* left block */
        ...
        htmlBuffer.push("<span class='tablePagination_perPage_span'>Bücher pro Seite:</span>"); // translate " per page" in your language
...
/* page from block */
        ...
        htmlBuffer.push("Seite"); // translate "Page " in your language
        ...
        htmlBuffer.push("von<span id='tablePagination_totalPages' class='tablePagination_totalPages'> "+totalPages+" </span>");  // translate " of " in your language
        htmlBuffer.push("</div>");
/* right arrows block */

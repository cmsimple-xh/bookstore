 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {
			firstArrow : (new Image()).src="plugins/bookstore/js/jtp/images/first.gif",
			prevArrow : (new Image()).src="plugins/bookstore/js/jtp/images/prev.gif",
			lastArrow : (new Image()).src="plugins/bookstore/js/jtp/images/last.gif",
			nextArrow : (new Image()).src="plugins/bookstore/js/jtp/images/next.gif",
			rowsPerPage : 5,
			currPage : 1,
...
/* left block */
        htmlBuffer.push("<div class='tablePagination_perPage'>");
        htmlBuffer.push("<span class='tablePagination_perPage_span'>Записей на странице:</span>"); // translate " per page" in your language
        htmlBuffer.push("<select id='tablePagination_rowsPerPage' class='tablePagination_rowsPerPage'>");
        htmlBuffer.push("<option value='10'>10</option></select>");
        htmlBuffer.push("</div>");
/* end - left block */
/* right block */
/* left arrows block */
        htmlBuffer.push("<div class='tablePagination_img_left'>");
        ...
        htmlBuffer.push("</div>");
/* page from block */
        htmlBuffer.push("<div class='tablePagination_pageof'>");
        htmlBuffer.push("Страница"); // translate "Page " in your language
        htmlBuffer.push("<input id='tablePagination_currPage' class='tablePagination_currPage_input' type='input' value='"+currPageNumber+"' size='4'>");
        htmlBuffer.push("из<span id='tablePagination_totalPages' class='tablePagination_totalPages'> "+totalPages+" </span>");  // translate " of " in your language
        htmlBuffer.push("</div>");
/* right arrows block */
        htmlBuffer.push("<div class='tablePagination_img_right'>");
